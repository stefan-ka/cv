...
\item Context Mapper (\href{https://contextmapper.org}{contextmapper.org}) open source project, \newline ``A Modeling Framework for Strategic Domain-driven Design''
	\begin{itemize}
		...
		\item Used Technologies: Domain-specific Language (DSL) with Xtext framework (Java, Xtend), Language server based on Language Server Protocol (LSP), Eclipse plugin (Java), Visual Studio Code extension (Typescript), Reverse engineering of microservice application architectures based on Spring Boot and Spring Web, Docker and Docker Compose, and Open API (OAS) specifications
	\end{itemize}
