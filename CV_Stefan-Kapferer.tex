...
\section{Experience}
\cventry{01/2021 -- Present}{Software Architect}{mimacom ag}{Zurich}{}{Architect and tech-lead in software engineering projects, DDD expert, leader of a team of 6 software engineers. \newline{}%
Projects and technologies:%
\begin{itemize}%
\item Migrosbank
	\begin{itemize}
		\item Banking application based on microservices architecture
		\item Onion architecture
		\item Domain-driven Design (DDD)
		\item Micro-Frontends with Vue
		\item Spring Boot backends with Kotlin
		\item Kubernetes
	\end{itemize}
\item smartIFU platform for Paul Büetiger AG)
  \begin{itemize}%
  \item Multi-tenant platform for manufacturers that offer IFUs (instructions for use) online (med-tech customers)
  \item Onion Architecture
  \item Domain-driven Design (DDD)
  \item Spring Boot backend (Java)
  \item Angular frontend (SPA)
  \item Kubernetes  
  \end{itemize}
\end{itemize}}
...
\cventry{02/2020 -- 12/2020}{Software Engineer and Project Lead}{IFS (continued)}{}{}{
\begin{itemize}%
...
\cventry{2021}{\href{https://contextmapper.org/media/SD-00-Java-06-SP-Kapferer-Zimmermann.pdf}{``Domain-Driven Design in der Praxis - Erfahrungen mit dem Open-Source-Tool Context Mapper'' (GERMAN)}}{JavaSPEKTRUM}{6/2021, pages 20-23}{}{\href{https://contextmapper.org/background-and-publications/}{https://contextmapper.org/background-and-publications/}}
...
\cventry{2020}{Domain-driven Service Design - Context Modeling, Model Refactoring and Contract Generation}{Papers From the 14th Advanced Summer School on Service-Oriented Computing (SummerSOC'20)}{}{}{\href{https://doi.org/10.1007/978-3-030-64846-6\_11}{https://doi.org/10.1007/978-3-030-64846-6\_11}}
...
and multiple graphical generators. More information can be found in the open source project \href{https://contextmapper.org}{contextmapper.org} for more information. \href{https://eprints.hsr.ch/821/}{https://eprints.hsr.ch/821/}}
